...
import { Form, Row, Col, Button, Icon , message , Popconfirm, Select , Input , DatePicker ,Badge} from 'antd';
  ...
  render(){
    ...
    const columns = [
      ...
      },    
      {
        ...
        render:(text,record)=>(
          <span>
              <Badge count={record.pickingDetailItemCount} overflowCount={999} style={{right:'-22px',zIndex:'0',top:4}} showZero>
