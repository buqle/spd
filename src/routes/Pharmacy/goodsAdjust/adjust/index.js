...
import {DatePicker, Form, Input, Row, Col, Button,Badge } from 'antd';
    ...
    const columns = [
     {
      ...
      },     
      {
       ...
       width: 178,
       render: (text,record) =>{
        return  <Badge count={record.roomLocAdjustDetailVoListCount} overflowCount={999} style={{right:'-18px',zIndex:'0',top: '8px'}} showZero>
