...
import { Form, Row, Col, DatePicker, Input, Select, Button, Icon, Modal, Radio, message,Badge } from 'antd';
    ...
    const columns = [
     {
      ...
      },    
      {
        ...
        width: 196,
        render: (text, record) => {
            return <Badge count={record.commonCheckBillDetailListCount} overflowCount={999} style={{right:'-22px',zIndex:'0',top: '8px'}} showZero><Link to={{ pathname: `/pharmacy/checkDecrease/newInventory/details/${record.checkBillNo}`}}>{text}</Link></Badge>
        }
      },
      {
        title: '状态',
