...
const columns = [
{
      ...
      },  
  {
   ...
   width: 178,
   render:(text, record)=>(
       <Badge count={record.instorDetailsItemsCount} overflowCount={999} style={{right:'-18px',zIndex:'0',top: '8px'}} showZero>
         <Link to={{pathname: `/pharmacy/wareHouse/newLibrary/details/${text}`}}>{text}</Link>
       </Badge>
   )
  },
  {
