...
class SearchForm extends PureComponent {
    ...
    render() {
        ...
        const {supplierList,factorList}=this.props
...
class RecallAndLocked extends PureComponent {
    ...
    getSup=()=>{
        this.props.dispatch({
            type: 'supplierFactor/supplierType',
            payload: { type: 'lic_type' },
            callback: ({data, code, msg}) => {
                if(code === 200) {
                    this.setState({
                        factorList: data
    ...
    render() {
        ...
        dataIndex: 'rowNum'
            ...
            },
            {
                ...
                className:'typecolor',
                render: (text, record) =>
                    <AddFactor record={record} supplierList={this.state.supplierList} factorList={this.state.factorList} onOk={this.saveFactior}>
                        {text}
                    </AddFactor>
            },
            {
        ...
        return (
            <div className='ysynet-main-content factor-content'>
                <SearchFormWarp
                    formProps={{...this.props}} _handlQuery={this.handlQuery} supplierList={this.state.supplierList} factorList={this.state.factorList}
                />
                <div>
                    <AddFactor record={{}} supplierList={this.state.supplierList}  factorList={this.state.factorList} onOk={this.saveFactior}>
