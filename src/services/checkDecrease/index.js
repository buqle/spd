...
//盘点新增批号
export function addNewLot(options) {
    return request(`${_local}/a/checkbilldetail/addNewLot`, {
        method: 'POST',
        type: 'formData',
        body: options
    })
...
//盘点新增批号－获取货位
export function findLocInfo(options) {
    return request(`${_local}/a/checkbilldetail/findLocInfo`, {
        method: 'POST',
        type: 'formData',
        body: options
    })
