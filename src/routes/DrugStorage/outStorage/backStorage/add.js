...
class AddRefund extends PureComponent{
  ...
  componentDidMount = () =>{
    ...
    if(this.props.match.path === "/drugStorage/outStorage/backStorage/editAdd/:backNo"){
        this.getDetail();
    }
    ...
    getDetail = () => {
        if (this.props.match.params.backNo) {
            ...
            this.props.dispatch({
                ...
                payload: { backNo},
                callback:(data)=>{
                    this.setState({editdetailsData: data });
                }
            });
        }
    }
  ...
  //提交该出库单
  backStroage = (flag) => {
    const { dataSource,editdetailsData ,selectedRows} = this.state;
    ...
    this.refs.remarksForm.validateFields((err, values) => {
      if(!err) {
        ...
        dispatch({
          ...
          payload: { ...postData },
          callback: () => {
            message.success(flag==2?'退货成功':'保存草稿成功');
            this.setState({
              okLoading:flag
            })
          ...
          if(!err){
              ...
              this.props.dispatch({
                  ...
                  payload: {
                      ...
                      backcauseOther:values.backcauseOther?values.backcauseOther:null
                  },
                  callback: ()=>{
                      message.success('提交草稿成功');
                      this.props.history.push('/drugStorage/outStorage/backStorage');
                  }
              });
          }
        })
  ...
  render(){
        ...
        render:(text, record,index) =>{
          return <InputNumber
                  ...
                  onChange={(value)=>{
                      ...
                      dataSource[index].backNum = value;
    ...
    const { visible, isEdit, dataSource, query, spinLoading, display, detailsData, supplierList,okLoading,editdetailsData } = this.state;
    const { getFieldDecorator } = this.props.form;
    return (
