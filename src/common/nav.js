    ...
    */
    ...
    },
    {
    ...
    },
      {
          name: "编辑草稿",
          icon: 'setting',
          path: '/drugStorage/outStorage/backStorage/editAdd/:backNo',
          component: dynamicWrapper(app, ['drugStorage/outStorage'], () => import('../routes/DrugStorage/outStorage/backStorage/add')),
      },
    {
      name: "退货详情",
      icon: 'setting',
      path: '/drugStorage/outStorage/backStorage/details/:backNo/:isDraft',
    ...
    //药剂科－供应商资质查询-企业资质查询
      {
          ...
          component: dynamicWrapper(app, ['drugStorage/supplierFactor'], () => import('../routes/Purchase/factorSearch/supplier')),
      },
//药剂科－供应商资质查询-药品资质查询
      {
          name: "药品资质查询",
    ...
    //药库－查询统计 - 药品台账
    {
      ...
      //药库－查询统计 - 药品台账新
      {
          name: "药品台账",
          icon: 'setting',
          path: '/drugStorage/stockMgt/drugLedgernew',
          component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/DrugStorage/stockMgt/drugLedger')),
      },
    //查询统计 - 近效期查询
    {
    ...
    },
    {
    ...
    },
      {
          name: '工作台',//系统管理-工作台
          icon: 'setting',
          path: '/systemMgt/workbenchMenu/workbench',
          component: dynamicWrapper(app, ['common/workbench'], () => import('../routes/SystemMgt/workbenchMenu/workbench'))
      },
    // 药房 - 盘点损益
    {
      name: "盘点损益",
    ...
    },
    {
      ...
      icon: 'setting',
      path: '/pharmacy/wareHouse/drugsFor/add/:applyCode/:status',
    ...
    },
    {
      ...
      {
          name: "退库草稿",//药库-出库-退库草稿
          icon: 'setting',
          path: '/pharmacy/outStorage/refund/editAdd/:backNo',
          component: dynamicWrapper(app, [], () => import('../routes/Pharmacy/outStorage/refund/add')),
      },
    {
      name: "退库-详情",//药库-出库-退库-详情
      icon: 'setting',
      path: '/pharmacy/outStorage/refund/details/:backNo/:isDraft',
    ...
    // 药房-出库-调拨出库
    {
      ...
      component: dynamicWrapper(app, ['drugStorage/outStorage'], () => import('../routes/Pharmacy/outStorage/newOut')),
    },
    // 药房-出库-调拨出库-详情
    {
      name: "调拨出库-详情",
    ...
    {
          name: "采购结算-补货管理--配送缺货管理",
          icon: 'setting',
          path: '/purchase/replenishment/shortage',
          component: dynamicWrapper(app, ['replenishment/replenish'], () => import('../routes/Purchase/replenishment/shortage')),
      },
      //批号调整
      {
          name: "全院管理-批号调整--批号调整",
          ...
          component: dynamicWrapper(app, ['purchase/batchAdjust'], () => import('../routes/Purchase/batchAdjust/editBatch')),
      },
      {
          name: "全院管理-批号调整-批号调整新增",
          icon: 'setting',
          path: '/purchase/batchAdjust/editBatch/add',
          component: dynamicWrapper(app, ['purchase/batchAdjust'], () => import('../routes/Purchase/batchAdjust/editBatch/add')),
      },
      {
          name: "全院管理-批号调整-批号调整审核",
          icon: 'setting',
      ...
      */
      {
          name: "全院管理-批号轮换-批号轮换",
          icon: 'setting',
          path: '/purchase/lotRot/editlotRot',
          component: dynamicWrapper(app, ['purchase/batchAdjust'], () => import('../routes/Purchase/lotRotation/editlotRot')),
      },
    //采购结算 - 结算管理 - 日对账单
    {
      name: "结算管理",
    ...
    */
      {
          name: "对账列表",
          icon: 'setting',
          path: '/purchase/settlementMgt/dayStatementsnew',
          component: dynamicWrapper(app, ['purchase/settlementMgt'], () => import('../routes/Purchase/settlementMgt/dayStatements')),
      },
      {
          name: "日对账单-详情",
          icon: 'setting',
          path: '/purchase/settlementMgt/dayStatementsnew/details/:id',
          component: dynamicWrapper(app, ['purchase/settlementMgt'], () => import('../routes/Purchase/settlementMgt/dayStatements/details')),
      },
    /**
     * @author QER
    ...
    */
      {
          ...
          component: dynamicWrapper(app, ['purchase/settlementMgt'], () => import('../routes/Purchase/settlementMgt/createSettle')),
      },
    //采购结算 - 结算管理 - 结算单
    {
      name: "结算管理",
    ...
    //采购结算 - 结算管理 - 结算单 - 详情
    {
       ...
       * @author QER
       * @date 19/3/21
       * @Description:药学科－结算管理－结余查询
      */
      {
          name: "结余查询",
          icon: 'setting',
          path: '/purchase/settlementMgt/surplusQuery',
          component: dynamicWrapper(app, ['purchase/settlementMgt'], () => import('../routes/Purchase/settlementMgt/surplusQuery')),
      },
    //采购结算 - 单据复核 - 发药单补登
    {
      name: "发药单补登",
    ...
    },
    {
    ...
    },
      {
          name: "统计分析 - 库存日志",
          icon: 'setting',
          path: '/purchase/statisticAnalysis/stockInquirnew',
          component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/Purchase/statisticAnalysis/stockInquiry')),
      },
      {
          name: "统计分析 - 库存查询 - 详情",
          icon: 'setting',
          path: '/purchase/statisticAnalysis/stockInquirnew/details/:deptCode/:drugCode/:hisDrugCode/:new',
    ...
    //采购结算 - 统计分析 - 呆滞库存查询
    {
      ...
      component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/Purchase/statisticAnalysis/stagnantDrugs')),
    },
      //采购结算 - 统计分析 - 库存对比
      {
          name: "库存对比",
          ...
          component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/Purchase/statisticAnalysis/comparison')),
      },
      //采购结算 - 统计分析 - 库存结存
      {
          name: "库存结存查询",
          ...
          component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/Purchase/statisticAnalysis/stockBalance')),
      },
      //采购结算 - 统计分析 - 移库消耗统计
      {
          name: "移库消耗统计",
          ...
          component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/Purchase/statisticAnalysis/reloConsume')),
      },
      //采购结算 - 统计分析 - 库存结存
      {
          name: "未结算对账药品查询",
          ...
          component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/Purchase/statisticAnalysis/unsettledDrugs')),
      },
     //采购结算 - 统计分析 - 近效期查询
      {
          name: "近效期查询",
    ...
    /*--创世新增2018-12-14-E--*/
      ...
      //查询统计 - 批号追溯 - 详情
      {
          ...
          component: dynamicWrapper(app, [], () => import('../routes/Purchase/statisticAnalysis/patientTracing/details')),
      },{
          name: "同比环比统计",
          icon: 'setting',
          path: '/purchase/statisticAnalysis/statisticsTraceability',
          component: dynamicWrapper(app, ['purchase/reportform'], () => import('../routes/Purchase/statisticAnalysis/statisticsTraceability')),
      },
      {
          name: "人员工作统计及追溯",
          icon: 'setting',
          path: '/purchase/statisticAnalysis/statisticsTraceability/detailsList/:deptCode/:backDeptCode/:startTime/:endTime',
          component: dynamicWrapper(app, [], () => import('../routes/Purchase/statisticAnalysis/statisticsTraceability/detailsList')),
      },
      {
          name: "人员单据追溯明细",
          icon: 'setting',
          path: '/purchase/statisticAnalysis/statisticsTraceability/details/:backNo',
          component: dynamicWrapper(app, ['purchase/reportform'], () => import('../routes/Purchase/statisticAnalysis/statisticsTraceability/details')),
      },
      /*人员工作统计	*/
      {
          name: "人员工作统计",
      ...
      /*人员工作统计	补货单*/
      {
          name: "人员工作统计-补货单",
          icon: 'setting',
          path: '/purchase/statisticAnalysis/personWorkStatistics/tracing/:guid/:userno/:username/:startTime/:endTime',
      ...
      //人员工作统计 - 补货单详情
      {
          ...
          component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/Purchase/statisticAnalysis/personWorkStatistics/details')),
      },
      {
          name: "人员验收单",
          icon: 'setting',
      ...
      //人员单据追溯明细 - 详情
      {
          ...
          component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/Purchase/statisticAnalysis/personWorkStatistics/detailsCheck')),
      },
      //补货明细
      {
          name: "补货单明细",
          ...
          component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/Purchase/statisticAnalysis/personWorkStatistics/tracingTotalList')),
      },
      //验收单明细
      {
          name: "验收单明细",
          icon: 'setting',
          path: '/purchase/statisticAnalysis/personWorkStatistics/acceptanceTotalList/:userid/:startTime/:endTime',
          component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/Purchase/statisticAnalysis/personWorkStatistics/acceptanceTotalList')),
      },
      //下架
      {
          name: "下架",
          icon: 'setting',
          path: '/purchase/statisticAnalysis/personWorkStatistics/lowerShelf/:userId/:startTime/:endTime/:userNo/:userName',
          component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/Purchase/statisticAnalysis/personWorkStatistics/lowerShelf')),
      },
      //出库复核
      {
          name: "出库复核",
          icon: 'setting',
          path: '/purchase/statisticAnalysis/personWorkStatistics/outgoingReview/:userId/:startTime/:endTime/:userNo/:userName',
          component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/Purchase/statisticAnalysis/personWorkStatistics/outgoingReview')),
      },
      //盘点
      {
          name: "盘点",
          icon: 'setting',
          path: '/purchase/statisticAnalysis/personWorkStatistics/inventory/:userId/:startTime/:endTime/:userNo/:userName',
          component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/Purchase/statisticAnalysis/personWorkStatistics/inventory')),
      },
      //调剂
      {
          name: "调剂",
          ...
          component: dynamicWrapper(app, ['purchase/statistics'], () => import('../routes/Purchase/statisticAnalysis/personWorkStatistics/dispensing')),
      },
      //发药复核
      {
          name: "发药复核",
          icon: 'setting',
          path: '/purchase/statisticAnalysis/personWorkStatistics/drugRechecking/:userId/:startTime/:endTime/:userNo/:userName',
