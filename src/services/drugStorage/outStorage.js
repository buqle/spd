...
export function outStoreDetailInfos(options) {
...
//出库单生成验收单
export function buildCheckAccept(options) {
    return request(`${_local}/a/common/outstoredetail/buildCheckAccept`, {
        method: 'POST',
        type: 'json',
        body: options
    })
...
// 退货-草稿单详情
export function editDraft(options) {
    return request(`${_local}/a/commonback/backdetail/editDraft`,{
        method: 'POST',
        type: 'formData',
        body: options
    })
...
// 退货-草稿单详情-头部
export function editDraftHead(options) {
    return request(`${_local}/a/commonback/back/editDraftHead`,{
        method: 'POST',
        type: 'formData',
        body: options
    })
...
// 退货 保存草稿
export function saveDraft(options) {
    return request(`${_local}/a/commonback/backdetail/saveDraft`,{
        method: 'POST',
        type: 'json',
        body: options
    })
...
export function submitDraft(options) {
    return request(`${_local}/a/commonback/backdetail/confirmEditDraft`,{
        method: 'POST',
        type: 'json',
        body: options
    })
