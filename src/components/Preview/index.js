                ...
                pic?
                    <div className='preview-list-side'>
                        ...
                        <Carousel  ref='img'>
                            ...
                            {
                                imgArr.map((item,index)=><div>
                                    <Zmage controller={{
                                    close: true,zoom: true,download: true,rotate: true,flip: true,pagination: true,
                                }} backdrop="rgba(247, 247, 247, 0.35)" radius={5} edge={20}  width='100%' key={index} src={`${item.original.path}${item.original.name}`} alt=""/></div> )
                            }
