...
//呆滞库存查询－部门
export function delayGetDeptInfo(options) {
    return request(`${_local}/a/statics/delayStore/getDeptInfo`, {
        method: 'GET',
        type: 'formData',
        body: options
    })
...
//呆滞库存查询－时间
export function delayGetTimeList(options) {
    return request(`${_local}/a/statics/delayStore/getTimeList`, {
        method: 'POST',
        type: 'formData',
        body: options
    })
}
export function proGetTimeList(options) {
    return request(`${_local}/a/statics/delayStore/getJxqTimeList`, {
        method: 'POST',
        type: 'formData',
        body: options
    })
...
//呆滞库存查询－导出
export function delayStoreExport(options) {
    return request(`${_local}/a/statics/delayStore/export`, {
        method: 'POST',
        type: 'formData',
        export: true,
        body: options
...
//库存结存－导出
export function storeBalanceExport(options) {
    return request(`${_local}/a/statics/storeBalance/export`, {
        method: 'POST',
        type: 'formData',
        export: true,
        body: options
...
//库存对比－导出
export function comparisoneExport(options) {
    return request(`${_local}/a/comparestock/export`, {
        method: 'POST',
        type: 'formData',
        export: true,
        body: options
...
//库存结存-存储地点
export function storeFindDepts(options) {
    return request(`${_local}/a/statics/storeBalance/findDepts`, {
        method: 'GET',
        type: 'formData',
        body: options
    })
...
//库存结存-供应商清单
export function findSuppliers(options) {
    return request(`${_local}/a/statics/storeBalance/findSuppliers`, {
        method: 'GET',
        type: 'formData',
        body: options
    })
...
//药品台账新－导出
export function medicineStandingExportNew(options) {
    return request(`${_local}/a/statics/medicineStanding/newExport`, {
        method: 'POST',
        type: 'formData',
        export: true,
        body: options
...
//人员统计补货单详情头部
export function getPurchaseOrderDetail(options) {
    return request(`${_local}/a/reportform/userwork/getPurchaseOrderDetail`, {
        method: 'POST',
        type: 'formData',
        body: options
    })
