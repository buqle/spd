      ...
      <div className='bgf fadeIn'>
        <Row>
          ...
          <Col span={12} style={{textAlign: 'right'}}>
            {
              detailsData && detailsData.status === 2|| detailsData && detailsData.status === 3|| detailsData && detailsData.status === 4 ?
        ...
        <hr className='hr'/>
          <div className="detailCard detailCards">
              <Row style={{display: 'flex', alignItems: 'center'}}>
                  <Col span={12} style={{ marginLeft: 4 }}>
                      <FetchSelect
                          ...
                          url={TableSearchUrl.searchacceptAnyReturns}
                          cb={(value, option) => {
              ...
              <Tabs
                  ...
                  tabBarExtraContent={
                      activeKey  === '1' && detailsData.status === 1||activeKey  === '1' && detailsData.status === 2 ?
