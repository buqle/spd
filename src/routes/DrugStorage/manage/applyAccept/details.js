    ...
    return (
      <div className='fullCol'>
        <div className='fullCol-fullChild'>
          <h3>单据信息 
            <Button type='danger' style={{float:'right'}} onClick={()=>this.ban()} >驳回</Button>
            <Button type='primary' className='button-gap' style={{float:'right'}} onClick={()=>this.onSubmit()}>确认受理</Button>
          </h3>
          <Row>
            <Col span={8}>
