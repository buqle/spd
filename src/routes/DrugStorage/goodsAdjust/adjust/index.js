...
import {DatePicker, Form, Input, Row, Col, Button, message, Badge} from 'antd';
    ...
    const columns = [ 
     {
      ...
      },   
      {
        ...
        render: (text,record) =>(
            <span>
              <Badge count={record.roomLocAdjustDetailVoListCount} overflowCount={999} style={{right:'-27px',zIndex:'0',top: '8px'}} showZero>
