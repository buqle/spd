...
import {Form, Input , Row, Col, Button, Icon, Select, DatePicker,Badge } from 'antd';
    ...
    const columns = [
     {
      ...
      },
      {
        ...
        render:(text, record)=>(
            ...
            <Link to={{pathname: `/baseDrug/wareHouse/drugApply/details/${record.applyCode}`}}>{text}</Link>
            </Badge>
                )
      },
      {
