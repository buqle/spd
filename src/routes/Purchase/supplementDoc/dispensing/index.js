...
import { DatePicker , Form, Input ,Select, Icon, Row, Col, Button  , message,Badge } from 'antd';
      ...
      },     
      {
       ...
       render: (text,record) =>(
           ...
           <Link to={{pathname: `/purchase/supplementDoc/dispensing/detail/${record.makeupCode}`}}>{text}</Link>
               <Badge count={record.makeupDetailItemCount} overflowCount={999} style={{right:'-18px',zIndex:'0',top: '0px'}} showZero></Badge>
            </span>
       )
      },
      {
