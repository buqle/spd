    ...
    this.props.dispatch({
      ...
      callback:(data)=>{
        ...
        this.setState({
          ...
          //goodsTypeSelect2: goodsVos[0].replan,
            adjust:{
...
//修改货位
      ...
      onOk:()=>{
        this.props.form.validateFields((err,values)=>{
          if(!err){
            ...
            const { supplier , replanStore , purchaseQuantity ,alternativeLoc,
  ...
  render(){
    const {
      ...
      fillBackData, 
      replanUnitSelect, 
      goodsTypeSelect, goodsTypeSelect2,
      supplierSelect, 
      medDrugType, 
      upperQuantity,
      downQuantity,
          ...
          >
            ...
            <Panel header="指示货位" key="4" style={customPanelStyle}>
              <Row>
                ...
                <Col span={10}>
                      <FormItem {...formItemLayout} label={`备选上架货位`}>
                          <Tooltip placement="bottom" title='单位默认包装规格'>
                              <Icon type="exclamation-circle" />
                          </Tooltip>
                          {
                              getFieldDecorator(`alternativeLoc`,{
                                  initialValue:fillBackData.alternativeLocName,
                              })(
                                  <Select
                                      style={{
                                          width: 200,
                                      ...
                                      placeholder={'请选择备选上架货位'}
                                      showSearch
                                      optionFilterProp="children"
                                      filterOption={(input, option) => option.props.children.toLowerCase().indexOf(input.toLowerCase()) >= 0}
                                  >
                                      {
                                          goodsTypeSelect2 && goodsTypeSelect2.length ?
