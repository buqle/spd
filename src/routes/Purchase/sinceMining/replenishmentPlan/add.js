...
import { Row, Col, Button, Table, Modal, Icon, Tooltip, message, Select, Spin, InputNumber,Upload } from 'antd';
import {replenishmentPlan} from '../../../../api/replenishment/replenishmentPlan';
import RemoteTable from '../../../../components/TableGrid';
import FetchSelect from '../../../../components/FetchSelectTwo/index';
    ...
    absfun = (e) => {
        ...
        request(replenishmentPlan.QUERYDRUGBYDEPT,{
            ...
            if(data.code === 200 && data.msg === 'success') {
                ...
                newData=list;
                if(list.length){
                    this.setState({ modalSelectedRows:newData})
                    this.handleOk();
                }else {
                    message.error('暂无此产品');
                    this.setState({
