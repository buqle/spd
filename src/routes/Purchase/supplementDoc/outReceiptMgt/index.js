...
const columns = [
      ...
      },    
  {
   ...
   width: 200,
   render:(text, record)=>
      <Badge count={record.outstoreDetailItemsCount} overflowCount={999} style={{right:'-27px',zIndex:'0',top: '8px'}} showZero>
      <Link to={{pathname: `/purchase/supplementDoc/outReceiptMgt/details/id=${record.backNo}&state=${record.outStoreStatus}`}}>{text}</Link>
      </Badge>
  },
  {
    title: '拣货单',
