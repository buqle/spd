  ...
  render() {
    ...
    const columns = [
    {
      ...
      },   
      {
        ...
        width: 196,
        render: (text, record) => {
            return <Badge count={record.commonCheckBillDetailListCount} overflowCount={999} style={{right:'-22px',zIndex:'0',top: '8px'}} showZero><Link to={{ pathname: `/pharmacy/checkDecrease/afterAdjustment/details/${record.checkBillNo}`}}>{text}</Link></Badge>
        }
      },
      {
        title: '状态',
