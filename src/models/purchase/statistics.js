...
export default {
  ...
  effects: {
    ...
    *getTimeList({payload, callback}, {call}) {
    ...
    //呆滞库存查询－部门
      *delayGetDeptInfo({payload, callback}, {call}) {
          const data = yield call(statistics.delayGetDeptInfo, payload);
          if(typeof callback === 'function') {
              callback && callback(data);
          };
      },
      //呆滞库存查询－时间
      *delayGetTimeList({payload, callback}, {call}) {
          const data = yield call(statistics.delayGetTimeList, payload);
          if(typeof callback === 'function') {
              callback && callback(data);
          };
      },
      //呆滞库存查询－临效期
      *proGetTimeList({payload, callback}, {call}) {
          const data = yield call(statistics.proGetTimeList, payload);
          if(typeof callback === 'function') {
              callback && callback(data);
          };
      },
      //呆滞库存查询－导出
      *delayStoreExport({payload, callback}, {call}) {
          const data = yield call(statistics.delayStoreExport, payload);
          if(typeof callback === 'function') {
              callback && callback(data);
          };
      },
      //库存结存－导出
      *storeBalanceExport({payload, callback}, {call}) {
          const data = yield call(statistics.storeBalanceExport, payload);
          if(typeof callback === 'function') {
              callback && callback(data);
          };
      },
      //库存对比－导出
      *comparisoneExport({payload, callback}, {call}) {
          const data = yield call(statistics.comparisoneExport, payload);
          if(typeof callback === 'function') {
              callback && callback(data);
          };
      },
    ...
    *getDeptByParam({payload, callback}, {call}) {
      ...
      *storeFindDepts({payload, callback}, {call}) {
          const data = yield call(statistics.storeFindDepts, payload);
          if(typeof callback === 'function') {
              callback && callback(data);
          };
      },
      //库存结存-供应商清单
      *findSuppliers({payload, callback}, {call}) {
          const data = yield call(statistics.findSuppliers, payload);
          if(typeof callback === 'function') {
              callback && callback(data);
          };
      },
    ...
    *medicineStandingExport({payload, callback}, {call}) {
      ...
      //药品台账新－导出
      *medicineStandingExportNew({payload, callback}, {call}) {
          const data = yield call(statistics.medicineStandingExportNew, payload);
          if(typeof callback === 'function') {
              callback && callback(data);
          };
      },
    ...
    *getRoomRepertoryDetail({payload, callback}, {call}) {
    ...
    //人员统计补货单详情头部
    *getPurchaseOrderDetail({payload, callback}, {call}) {
          const data = yield call(statistics.getPurchaseOrderDetail, payload);
          if(typeof callback === 'function') {
              callback && callback(data);
          };
     },
