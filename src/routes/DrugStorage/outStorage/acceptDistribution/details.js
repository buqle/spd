  ...
  getDatailInfo = (value) => {
    ...
    if (this.props.match.params.applyCode) {
      ...
      this.props.dispatch({
        ...
        payload: { applyCode,...this.state.query,hisDrugCode:val },
        query:{hisDrugCode:val},
        callback:(data)=>{
          this.setState({ 
            detailsData: data, 
                    ...
                    <Row style={{display: 'flex', alignItems: 'center'}}>
                      <Col span={12} style={{ marginLeft: 4 }}>
                        <FetchSelect
                          ...
                          placeholder='药品名称'
                          deptStateb={' '}
                          url={TableSearchUrl.searchoutStorageacceptDistribution}
                          cb={(value, option) => {
