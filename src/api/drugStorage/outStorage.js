...
export const outStorage = {
  ...
  PRINT_DETAIL_A: `${_local}/a/outStoreDetail/print/printDetailA4`,     //出库A4打印
  OUT_DETAIL: `${_local}/a/deliver/print/exportAsPrint`,     //出库导出excel
  PICKING_PRINT: `${_local}/a/pickingDetail/print/printDetail`,     //拣货下架打印
  PICKING_PRINT_A: `${_local}/a/pickingDetail/print/printDetailA4`,     //拣货A4下架打印
  ...
  OUTSTOREDETAILLIST: `${_local}/a/common/outstoredetail/outStoreDetailList`,  //拣货下架详情分页
}